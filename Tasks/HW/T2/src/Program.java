...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        if (input <= 0) {
            ...
            int input = input - value5000 * 5000;

            int value1000 = input / 1000;
            int input = input - value1000 * 1000;

            int value500 = input / 500;
            int input = input - value500 * 500;

            int value100 = input / 100;
            int input = input - value100 * 100;

            int value50 = input / 50;
            int input = input - value50 * 50;

            int value10 = input / 10;
            int input = input - value10 * 10;

            int value5 = input / 5;
            int input = input - value5 * 5;

            int value2 = input / 2;
            int input = input - value2 * 2;

            int value1 = input / 1;
            int input = input - value1 * 1;
